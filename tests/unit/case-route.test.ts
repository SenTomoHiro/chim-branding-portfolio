...
const item: PortfolioCase = { id: "A-01", brandName: "堡乎乎 Manual Burger", projectName: "", intro: "", business: "branding", categories: ["food"], primaryIndustry: "餐饮", cover: "", coverWidth: 1400, coverHeight: 1050, hero: "", bodyAssets: [], published: true, includeInPortfolioPdf: true, portfolioPdfImageIds: [] };
