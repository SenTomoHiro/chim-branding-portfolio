...
const item=(id:string,published=true,categories:PortfolioCase["categories"]=["other"]):PortfolioCase=>({id,name:id,intro:"",business:"branding",categories,primaryIndustry:"",cover:"",coverWidth:1400,coverHeight:1050,hero:"",bodyAssets:[],published,includeInPortfolioPdf:published,portfolioPdfImageIds:[]});
