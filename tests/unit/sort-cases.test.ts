...
const item=(id:string,published=true):PortfolioCase=>({id,slug:id.toLowerCase(),name:id,intro:"",industryPrimary:"",industryTags:[],designPrimary:"",designTags:[],cover:"",hero:"",bodyAssets:[],published});
