...
const item=(id:string,published=true,categories:PortfolioCase["categories"]=["other"]):PortfolioCase=>({id,brandName:id,projectName:"",intro:"",business:"branding",categories,primaryIndustry:"",cover:"",coverWidth:1400,coverHeight:1050,hero:"",bodyAssets:[],published,includeInPortfolioPdf:published,portfolioPdfHeroSelected:false,portfolioPdfCoverSelected:false});
