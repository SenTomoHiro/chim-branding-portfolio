...
const item=(id:string,published=true,categories:PortfolioCase["categories"]=["other"]):PortfolioCase=>({id,brandName:id,projectName:"",intro:"",business:"branding",categories,primaryIndustry:"",media:[],published,includeInPortfolioPdf:published});
